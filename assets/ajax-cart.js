...
var ajaxCart = (function(module, $) {
  ...
  itemErrorCallback = function (XMLHttpRequest, textStatus, form) {
    ...
    if (!!data.message) {
      if (data.status == 422) {
        var $addButtoncontainer = $('.product-add', form);
      ...
      */
      ...
      if ( cartItem.selling_plan_allocation ) {
        var sellingPlanAllocation = cartItem.selling_plan_allocation.selling_plan,
              sellingPlanAllocationName = cartItem.selling_plan_allocation.selling_plan.name;
      } else {
        var sellingPlanAllocation = false,
              sellingPlanAllocationName = false;
      }
      ...
      item = {
        ...
        sellingPlanAllocationName: sellingPlanAllocationName
      };
